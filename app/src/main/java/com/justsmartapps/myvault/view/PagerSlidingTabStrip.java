...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.selector_dialog_button;
	private Locale locale;
	public int currentPostionOffSetPixels;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		textColor = context.getResources().getColor(
				R.drawable.selector_text_black_white);
		tabsContainer = new LinearLayout(context);
		tabsContainer.setOrientation(LinearLayout.HORIZONTAL);
		tabsContainer.setWeightSum(1);
	...
	private void addTextTab(final int position, String title) {
		FlatTextView tab = new FlatTextView(getContext());
		tab.setText(title);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset,
			...
			currentPostionOffSetPixels = positionOffsetPixels;
